...
import { getSpecificFuldmagt, issueAgainFuldmagt, revokeFuldmagt } from '../../services/fuldmagt.services';
        ...
        <div className='max-w-sm w-full space-y-4'>
          ...
          <div className="text-center mt-4">
            ...
            <div className="flex items-center justify-center mt-2">
              ...
              <span className="ml-3 text-gray-600">{formatDate(expiredDate)}</span>
            </div>
            <button 
...
const RevokeModal = ({revokedDate, isOpen, setIsOpen, callBackFunction}) => {
        ...
        <div className='max-w-sm w-full space-y-4'>
          ...
          <div className="text-center mt-4">
            ...
            <div className="flex items-center justify-center mt-2">
              ...
              <span className="ml-3 text-gray-600">{formatDate(revokedDate)}</span>
            </div>
            <button 
            onClick={()=>{
                callBackFunction()
...
const RevokeConfirmationModal = ({isOpen, setIsOpen, callBackFunction}) => {
        ...
        <div className='max-w-sm w-full space-y-4'>
          ...
          <div className="text-center mt-4">
            ...
            <div className="flex items-center justify-center space-x-4 ">
              ...
              className="bg-primary w-full mt-6 px-4 py-2 bg-white border border-gray-300 rounded-md text-gray-700 hover:bg-gray-100">
                Yes
              </button>
            </div>
          </div>
    ...
    <div className="flex flex-col space-y-4 w-full justify-center items-center">
      ...
      { (fuldmagt.fuldmagtGiverId == credentials.user._id || (credentials.company && fuldmagt.fuldmagtGiverId == credentials.company._id)) &&
        <> 
            ...
            <ExpiredModal expiredDate={fuldmagt.expiry} isOpen={isExpired} setIsOpen={setExpired} callBackFunction={issueAgainCall}/>
            <RevokeModal revokedDate={fuldmagt.revokedDate} isOpen={isRevoked} setIsOpen={setRevoked} callBackFunction={issueAgainCall}/>

            {
                (new Date() < fuldmagt.expiry) &&
                
                <RevokeConfirmationModal isOpen={openRevoke} setIsOpen={setOpenRevoke} callBackFunction={revokeCall}/>
            }
        </>
      }
    </div>
